...
# Includes in <head>
# ------------------
app_include_js = "/assets/property_rent_management/js/property_rent_management.bundle.js"
app_include_css = "/assets/property_rent_management/css/property_rent_management.bundle.css"
